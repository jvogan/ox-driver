...
`, { mode: 0o700 });
	...
	const env = {
		...
		OX_DRIVER_REQUESTED_RUN_ID: "11111111-1111-4111-8111-111111111111",
	};
	...
	await assert.rejects(
		execFileAsync(process.execPath, [cli, "cancel", "22222222-2222-4222-8222-222222222222"], { env: stateOnlyEnv }),
		(error) => {
