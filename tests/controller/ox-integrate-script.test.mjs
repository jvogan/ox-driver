...
async function childReceipt(value, { runId, changedPaths, patch, baseCommit, tamper = false }) {
...
test("integrate proposes, exports two non-conflicting changes, identifies one conflict, and applies with passing checks", async () => {
